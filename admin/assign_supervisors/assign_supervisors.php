			...
			$regions = array("Kigali city","Southern Region","Eastern Region","Western Region",
			  "Ashanti Region","Northern Region","Upper East Region","Upper West","Volta Region","Brong Ahafo Region");

			$regions_2 = array("-- Select Resident Region --","Kigali city Region","Southern Region","Eastern Region","Western Region",
			  "Ashanti Region","Northern Region","Upper East Region","Upper West Region","Volta Region","Brong Ahafo Region");

			$faculties = array("-- Select Lecturer Faculty --","BIT","HRM","FOE","TTM","FHAS");
			...
			$mysql_query_fast = "SELECT * FROM visiting_lecturers WHERE lecturer_faculty = 'BIT'";
			$mysql_query_fbms = "SELECT * FROM visiting_lecturers WHERE lecturer_faculty = 'HRM'";
			$mysql_query_foe = "SELECT * FROM visiting_lecturers WHERE lecturer_faculty = 'FOE'";
			$mysql_query_fbne = "SELECT * FROM visiting_lecturers WHERE lecturer_faculty = 'TTM'";
					  ...
					  <h2 class = "panel-title ptitle"> Assign Supervisors</h2>
						...
						<div class = "panel-heading phead">
						  ...
						  <table class="table table-bordered table-hover">
							  ...
							  <thead>
								<tr>
									<th style="text-align:center">Kigali city</th>
									<th style="text-align:center">Ouestern</th>
			...
			<?php 
				...
				if(isset($_POST["btn-assign-lecturers"])){
					...
					$mysql_insert_central_query = "INSERT INTO `assigned_lecturers` (`id`, `regions`, `first_supervisor_fast`, `second_supervisor_fast`, `first_supervisor_fbms`, `second_supervisor_fbms`, `first_supervisor_foe`, `second_supervisor_foe`, `first_supervisor_fbne`, `second_supervisor_fbne`, `first_supervisor_fhas`, `second_supervisor_fhas`, `date`) VALUES (NULL, 'Southern Region', '$lecturer_1_central_fast', '$lecturer_2_central_fast', '$lecturer_1_central_fbms', '$lecturer_2_central_fbms', '$lecturer_1_central_foe', '$lecturer_2_central_foe', '$lecturer_1_central_fbne', '$lecturer_2_central_fbne', '$lecturer_1_central_fhas', '$lecturer_2_central_fhas', CURRENT_TIMESTAMP)"; 			
					...
					$assign_vira_students_lecturers_accra_fast = "UPDATE industrial_registration SET visiting_supervisor_name = '$lecturer_2_accra_fast' WHERE faculty='FAST' AND attachment_region='Kigali City'";
						
					$execute_assign_vira_students_lecturers_accra_fast = mysqli_query($conn,$assign_vira_students_lecturers_accra_fast);
						
						//
						
					$assign_vira_students_lecturers_accra_fbms = "UPDATE industrial_registration SET visiting_supervisor_name = '$lecturer_2_accra_fbms' WHERE faculty='FBMS' AND attachment_region='Kigali City'";
						
					$execute_assign_vira_students_lecturers_accra_fbms = mysqli_query($conn,$assign_vira_students_lecturers_accra_fbms);
						
						//
						
					$assign_vira_students_lecturers_accra_foe = "UPDATE industrial_registration SET visiting_supervisor_name = '$lecturer_2_accra_foe' WHERE faculty='FOE' AND attachment_region='Kigali City'";
						
					$execute_assign_vira_students_lecturers_accra_foe = mysqli_query($conn,$assign_vira_students_lecturers_accra_foe);
						
						//
						
					$assign_vira_students_lecturers_accra_fbne = "UPDATE industrial_registration SET visiting_supervisor_name = '$lecturer_2_accra_fbne' WHERE faculty='FBNE' AND attachment_region='Kigali City'";
						
					$execute_assign_vira_students_lecturers_accra_fbne = mysqli_query($conn,$assign_vira_students_lecturers_accra_fbne);
						
						//
						
					$assign_vira_students_lecturers_accra_fhas = "UPDATE industrial_registration SET visiting_supervisor_name = '$lecturer_2_accra_fhas' WHERE faculty='FHAS' AND attachment_region='Kigali City'";
						
					$execute_assign_vira_students_lecturers_accra_fhas = mysqli_query($conn,$assign_vira_students_lecturers_accra_fhas);
						
						//  Southern Region
						
					$assign_vira_students_lecturers_central_fast = "UPDATE industrial_registration SET visiting_supervisor_name = '$lecturer_2_central_fast' WHERE faculty='FAST' AND attachment_region='Southern Region'";
						
					$execute_assign_vira_students_lecturers_central_fast = mysqli_query($conn,$assign_vira_students_lecturers_central_fast);
						
						//
						
					$assign_vira_students_lecturers_central_fbms = "UPDATE industrial_registration SET visiting_supervisor_name = '$lecturer_2_central_fbms' WHERE faculty='FBMS' AND attachment_region='Southern Region'";
						
					$execute_assign_vira_students_lecturers_central_fbms = mysqli_query($conn,$assign_vira_students_lecturers_central_fbms);
						
						//
						
					$assign_vira_students_lecturers_central_foe = "UPDATE industrial_registration SET visiting_supervisor_name = '$lecturer_2_central_foe' WHERE faculty='FOE' AND attachment_region='Southern Region'";
						
					$execute_assign_vira_students_lecturers_central_foe = mysqli_query($conn,$assign_vira_students_lecturers_central_foe);
						
						//
						
					$assign_vira_students_lecturers_central_fbne = "UPDATE industrial_registration SET visiting_supervisor_name = '$lecturer_2_central_fbne' WHERE faculty='FBNE' AND attachment_region='Southern Region'";
						
					$execute_assign_vira_students_lecturers_central_fbne = mysqli_query($conn,$assign_vira_students_lecturers_central_fbne);
						
						//
						
					$assign_vira_students_lecturers_central_fhas = "UPDATE industrial_registration SET visiting_supervisor_name = '$lecturer_2_central_fhas' WHERE faculty='FHAS' AND attachment_region='Southern Region'";
